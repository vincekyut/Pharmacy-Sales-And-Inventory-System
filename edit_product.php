...
$id = $_GET['id'];
$query = "SELECT * FROM product_list WHERE product_id = ?";
...
$inv_query = "SELECT quantity FROM inventory WHERE product_id = ? LIMIT 1";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!isset($error_message)) {
        ...
        if (!$stmt) {
            ...
            mysqli_stmt_bind_param($stmt, "sddsissi", $prod_name, $cost_price, $selling_price, $prod_measure, $prod_qty, $prod_expiry, $image_path, $id);
    ...
    <div class="dashboard-container">
        <div class="sidebar" id="sidebar">
            ...
            <ul class="menu">
              ...
              <li data-title="Receive"><a href="receive_products"><i class="fas fa-truck-loading"></i> <span>Receive Product</span></a></li>
        ...
        <div class="main-content" id="main-content">
            ...
            if (!file_exists($uploads_dir)) {
                echo "<div class='alert alert-danger'>Warning: Uploads directory does not exist. Attempting to create it.</div>";
                if (mkdir($uploads_dir, 0777, true)) {
                    echo "<div class='alert alert-success'>Successfully created uploads directory.</div>";
                } else {
                    echo "<div class='alert alert-danger'>Failed to create uploads directory. Please check server permissions.</div>";
                }
            } else if (!is_writable($uploads_dir)) {
                echo "<div class='alert alert-danger'>Warning: Uploads directory is not writable. Please check permissions.</div>";
            }
            ?>
            ...
            <div class="form-container">
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        <div class="form-col">
                            <div class="form-group">
                                ...
                                <input type="number" id="unit_price" name="cost_price" class="form-control" step="0.01" min="0" value="<?php echo $product['unit_price']; ?>" required>
                            </div>
                        </div>
                    ...
                    <div class="form-row">
                        <div class="form-col">
                            <div class="form-group">
                                ...
                                <input type="number" id="quantity" name="quantity" class="form-control" min="0" value="<?php echo $inventory_quantity; ?>" required>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        <label for="product_image">Product Image <?php if(!empty($product['image_path'])): ?>(Optional)<?php endif; ?></label>
